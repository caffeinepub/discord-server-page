...
export class Backend implements backendInterface {
    ...
    async getFeatureHighlights(): Promise<Array<FeatureHighlight>> {
        if (this.processError) {
            try {
                const result = await this.actor.getFeatureHighlights();
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getRules(): Promise<Array<string>> {
        if (this.processError) {
            try {
    ...
    async getServerInfo(arg0: Principal): Promise<ServerInfo> {
        if (this.processError) {
            try {
    ...
    async updateFeatureHighlights(arg0: Array<FeatureHighlight>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateFeatureHighlights(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateRules(arg0: Array<string>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateRules(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateServerInfo(arg0: string, arg1: string, arg2: string, arg3: string, arg4: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateServerInfo(arg0, arg1, arg2, arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
